...
_A depiction of the VCR pipeline with image segmentation, concept formation, and data slicing_
...
_A depiction of ICQ's quantization and filtering for spatial-semantic image search_
