...
EMBED_DIR=/data/jie/slicing/data/bdd100k/embeds/sam_siglip
PK=10
N_QUERIES=1000
INDEX_TYPE="flat"
OUTPUT_DIR="k2_tests_bdd100k_train_SIGLIP_pk(${PK})_n(${N_QUERIES})_idx(${INDEX_TYPE})"
IMAGE_DIR="/data/jie/slicing/data/bdd100k/100k_train"
...
run_test() {
    ...
    local PICKLE_FILE="BDD100K_train_SIGLIP_flat_1000_embeds.pkl"
