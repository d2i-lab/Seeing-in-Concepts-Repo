...
EMBED_DIR=/data/jie/slicing/data/LVIS/train2017_siglip/
PK=10
N_QUERIES=1000
INDEX_TYPE="flat"
OUTPUT_DIR="k2_tests_LVIS_train2017_SIGLIP_pk(${PK})_n(${N_QUERIES})_idx(${INDEX_TYPE})"
IMAGE_DIR="/data/jie/slicing/data/LVIS/train2017"
...
run_test() {
    ...
    local PICKLE_FILE="LVIS_train2017_SIGLIP_flat_1000_embeds.pkl"
